...
class NetworkLightApplication: public Poco::Util::ServerApplication
{
public:
    NetworkLightApplication(): _helpRequested(false)
    {
    }
    
    ~NetworkLightApplication()
    {
    }
