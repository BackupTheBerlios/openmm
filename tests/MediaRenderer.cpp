...
{
    m_description["/MediaRenderer.xml"] = &MediaRenderer::m_deviceDescription;
    m_description["/RenderingControl.xml"] = &RenderingControl::m_description;
    m_description["/ConnectionManager.xml"] = &ConnectionManager::m_description;
    m_description["/AVTransport.xml"] = &AVTransport::m_description;
