...
#ifndef __RECSTREAMER_H
#define __RECSTREAMER_H
...
class cRecStreamerControl : public cControl/*, cReceiver*/ {
private:
  cRecStreamer *player;
public:
  cRecStreamerControl(const char *FileName);
       // Sets up a player for the given file.
  virtual ~cRecStreamerControl();
  bool Active(void);
  void Stop(void);
...
/*  // cReceiver methods
  ...
  void Start(cTBSocket *sock);
  };

#endif //__RECSTREAMER_H
