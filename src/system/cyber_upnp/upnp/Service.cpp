...
ServiceData * Service::getServiceData()
	{
	   cout << "getServiceData(), getServiceNode()" << endl;
		CyberXML::Node *node = getServiceNode();
	   cout << "getServiceData(), check if node == NULL" << endl;
		if (node == NULL) {
	               cout << "getServiceData(), getServiceNode() node == NULL" << endl;
			return NULL;
                }
	   cout << "getServiceData(), getUserData()" << endl;
...
// 		throw InvalidDescriptionException(msg.c_str()); 
	...
	cout << "Service::loadSCPD(), getServiceData()" << endl;
	ServiceData *data = getServiceData();
	cout << "Service::loadSCPD(), setSCPDNode()" << endl;
	data->setSCPDNode(scpdNode);

	cout << "Service::loadSCPD(), initServiceData()" << endl;
	initServiceData();
	cout << "Service::loadSCPD(), initActionList()" << endl;
	initActionList();
	cout << "Service::loadSCPD(), initServiceStateTable()" << endl;
	initServiceStateTable();
