...
// MediaContainer("Web Radio", "musicContainer")
{
    ...
    Omm::Av::MediaObject* pSomaFM = new Omm::Av::MediaObject;
    setIsContainer(false);
    pSomaFM->setObjectId("11");
    pSomaFM->setTitle("SOMA FM - Groove Salad (mp3)");
    Omm::Av::Resource* pSomaFMRes = new Omm::Av::Resource("r1", protInfoMp3, 0);
    pSomaFMRes->setUri("http://streamer-dtc-aa04.somafm.com:80/stream/1018");
    pSomaFM->addResource(pSomaFMRes);
    appendChild(pSomaFM);
    
    
//     appendChild(new Omm::Av::MediaItem("11", "SOMA FM - Groove Salad (any protocol)",
