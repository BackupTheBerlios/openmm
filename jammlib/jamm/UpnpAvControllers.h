...
public:
    ...
    void ImportResource(const Jamm::uri& SourceURI, const Jamm::uri& DestinationURI, Jamm::ui4& TransferID);
    ...
    void DeleteResource(const Jamm::uri& ResourceURI);
    ...
    void _reqImportResource(const Jamm::uri& SourceURI, const Jamm::uri& DestinationURI);
    void _reqGetTransferProgress(const Jamm::ui4& TransferID);
    void _reqDeleteResource(const Jamm::uri& ResourceURI);
...
protected:
    ...
    virtual void _ansImportResource(const Jamm::uri& SourceURI, const Jamm::uri& DestinationURI, const Jamm::ui4& TransferID) = 0;
    ...
    virtual void _ansDeleteResource(const Jamm::uri& ResourceURI) = 0;
